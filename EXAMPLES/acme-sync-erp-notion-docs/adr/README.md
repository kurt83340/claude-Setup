...
- _(aucune pour l'instant — les contraintes ACME sont capturées dans [../cadrage/README.md](../cadrage/README.md))_

### 🎨 mvp — Décisions projet structurantes

| #    | Titre                                                                   | Statut      |
| ---- | ----------------------------------------------------------------------- | ----------- |
| 0001 | [Stack n8n on-prem + Python](0001-mvp-stack-n8n-python.md)              | ✅ Accepted |
| 0002 | [Auth SAP B1 session token rotatif](0002-mvp-auth-session-token-sap.md) | ✅ Accepted |
| 0003 | [Storage delta n8n Data Tables](0003-mvp-storage-n8n-data-tables.md)    | ✅ Accepted |
