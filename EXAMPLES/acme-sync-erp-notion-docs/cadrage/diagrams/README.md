...
Pour diagrammes simples (flow linéaire, arbres). Mets-les directement dans `cadrage/README.md` ou dans un `.md` ici. Exemple : [`flow-business-acme.md`](flow-business-acme.md).
...
```markdown
Voir [flow business](diagrams/flow-business-acme.md)
ou
![Flow business](diagrams/flow-business-acme.svg)
```
